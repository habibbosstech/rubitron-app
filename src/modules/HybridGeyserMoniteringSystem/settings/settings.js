...
const SettingScreen = props => {
  ...
  const geyserRoutines = useSelector(state => state.hybridgeyser.geyserRoutines);

  const addRoutineLoading = useSelector(state=> state.hybridgeyser.addRoutineLoading)
  // const [Data, setData] = useState([
  //   geyserModule[selectedModule]?.scheduling?.routine,
  // ]);
  const RoutinesLoading = useSelector(state => state.hybridgeyser.RoutinesLoading);
          ...
          <View>
            <Card containerStyle={styles.card}>
              ...
              <View style={styles.viewStyle}>
                <Text style={{fontSize:30, marginTop: hp('0.5%'), fontWeight:'bold' }}>
